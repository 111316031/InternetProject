...
class NetworkManager:
    def __init__(self):
        ...
        self.on_connected: Optional[Callable[[], None]] = None         # 連線成功回呼: lambda: ...
        self.on_disconnected: Optional[Callable[[str], None]] = None      # 斷線回呼: lambda reason: ...
        self.on_receive_message: Optional[Callable[[dict[str, Any]], None]] = None   # 接收完整 JSON 數據回呼: lambda data_dict: ...
        self.on_error: Optional[Callable[[str], None]] = None             # 通訊錯誤回呼: lambda err_msg: ...
